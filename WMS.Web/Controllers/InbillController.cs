...
namespace WMS.WebApi.Controllers
{
    ...
    public class InbillController : ControllerBase
    {
        ...
        public InbillController(IInbillService iInbillService)
        {
        ...
        [HttpGet("Create")]
        public async Task<ApiResult> CreateUser([FromBody] Inbill inbill)
        {
        ...
        public async Task<ApiResult> Create([FromQuery] int page, [FromQuery] int size)
        {
            ...
            var data = await _iInbillService.QueryAsync(page, size, total);
